    ...
    public function parse(string $phql): array
    {
        ...
        while (($scannerStatus = $scanner->scanForToken()) === ScannerStatus::OK) {
            ...
            match ($scanner->getToken()->opcode) {
                ...
                Opcode::OP_MATCHES   => $parserObject->phql_(\phql_Parser::PHQL_OP_MATCHES),
                Opcode::OP_CONTAINS  => $parserObject->phql_(\phql_Parser::PHQL_OP_CONTAINS),
                Opcode::OP_CONTAINED => $parserObject->phql_(\phql_Parser::PHQL_OP_CONTAINED),
                Opcode::OP_OVERLAPS  => $parserObject->phql_(\phql_Parser::PHQL_OP_OVERLAPS),
                Opcode::OP_CONCAT    => $parserObject->phql_(\phql_Parser::PHQL_OP_CONCAT),
                Opcode::OP_JSON_GET  => $parserObject->phql_(\phql_Parser::PHQL_OP_JSON_GET),
                Opcode::OP_JSON_GET_TEXT  => $parserObject->phql_(\phql_Parser::PHQL_OP_JSON_GET_TEXT),
                Opcode::OP_JSON_PATH      => $parserObject->phql_(\phql_Parser::PHQL_OP_JSON_PATH),
                Opcode::OP_JSON_PATH_TEXT => $parserObject->phql_(\phql_Parser::PHQL_OP_JSON_PATH_TEXT),
